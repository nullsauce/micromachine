...
{
	code_gen().emit_ins16("00000iiiiimmmddd", IMM_0, R7, R0);
...
{
	code_gen().emit_ins16("00000iiiiimmmddd", IMM_0, R0, R7);
	setExpectedXPSRflags("nZC");
	setCarry();
...
{
	code_gen().emit_ins16("00000iiiiimmmddd", IMM_3, R1, R0);
	setExpectedXPSRflags("Nzc");
...
{
	code_gen().emit_ins16("00000iiiiimmmddd", IMM_4, R1, R0);
	setExpectedXPSRflags("nzC");
...
{
	code_gen().emit_ins16("00000iiiiimmmddd", IMM_31, R0, R0);
	setExpectedXPSRflags("Nzc");
...
{
	code_gen().emit_ins16("00000iiiiimmmddd", IMM_1, R0, R0);
	setExpectedXPSRflags("nzC");
