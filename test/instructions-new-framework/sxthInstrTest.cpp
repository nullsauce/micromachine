...
{
	code_gen().emit_ins16("1011001000mmmddd", R7, R0);
...
{
	code_gen().emit_ins16("1011001000mmmddd", R0, R7);
...
{
	code_gen().emit_ins16("1011001000mmmddd", R6, R1);
...
{
	code_gen().emit_ins16("1011001000mmmddd", R2, R5);
