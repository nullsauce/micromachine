...
char commands[64];
snprintf(commands,
sizeof(commands), "+$Z3,%x,4#", INITIAL_SP - 4);
mockIComm_InitReceiveChecksummedData(commands,
"+$c#");
m_pContext->R[1] = INITIAL_SP - 4;
IMemory_Write32(m_pContext
->pMemory, INITIAL_SP - 4, 0xBAADF00D);
...
char commands[64];
snprintf(commands,
sizeof(commands), "+$Z2,%x,4#", INITIAL_SP - 4);
mockIComm_InitReceiveChecksummedData(commands,
"+$c#");
...
EXPECT_EQ(0xBAADF00D,
IMemory_Read32(m_pContext
->pMemory, INITIAL_SP - 4));
}
...
char commands[64];
snprintf(commands,
sizeof(commands), "+$Z4,%x,4#", INITIAL_SP - 4);
mockIComm_InitReceiveChecksummedData(commands,
"+$c#");
m_pContext->R[0] = 0xBAADF00D;
m_pContext->R[1] = INITIAL_SP - 4;
...
char commands[64];
snprintf(commands,
sizeof(commands), "+$Z3,%x,1#", INITIAL_SP - 4);
mockIComm_InitReceiveChecksummedData(commands,
"+$c#");
m_pContext->R[1] = INITIAL_SP - 4;
IMemory_Write8(m_pContext
->pMemory, INITIAL_SP - 4, 0x5A);
...
char commands[64];
snprintf(commands,
sizeof(commands), "+$Z2,%x,2#", INITIAL_SP - 4);
mockIComm_InitReceiveChecksummedData(commands,
"+$c#");
m_pContext->R[0] = 0xBAADF00D;
m_pContext->R[1] = INITIAL_SP - 4;
...
char commands[64];
snprintf(commands,
sizeof(commands), "+$Z3,%x,8#", INITIAL_SP - 8);
mockIComm_InitReceiveChecksummedData(commands,
"+$c#");
m_pContext->R[1] = INITIAL_SP - 4;
IMemory_Write32(m_pContext
