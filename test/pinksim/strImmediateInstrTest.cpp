...
PINKY_TEST(strImmediate, T1UseAMixOfRegistersWithSmallestImmediateOffset)
{
...
PINKY_TEST(strImmediate, T1UseAnotherMixOfRegistersWithLargestImmediateOffset)
{
...
PINKY_TEST(strImmediate, T1AttemptUnalignedStore)
{
...
PINKY_TEST(strImmediate, T1AttemptStoreToInvalidAddress)
{
...
PINKY_TEST(strImmediate, T2HighestRegisterWithSmallestImmediateOffset)
{
...
PINKY_TEST(strImmediate, T2LowestRegisterWithLargestImmediateOffset)
{
