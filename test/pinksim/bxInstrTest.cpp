...
PINKY_TEST(bx, UseLowestRegisterToBranchToEvenAddressWhichClearsThumbModeToCauseHardFaultOnNextInstruction)
{
...
PINKY_TEST(bx, UseHighestRegisterToBranchToOddAddressWhichIsRequiredForThumb)
{
