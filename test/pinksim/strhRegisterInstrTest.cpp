...
PINKY_TEST(strhRegister, UseAMixOfRegistersWordAligned)
{
...
PINKY_TEST(strhRegister, UseAnotherMixOfRegistersWordAligned)
{
...
PINKY_TEST(strhRegister, YetAnotherMixOfRegistersNotWordAligned)
{
...
PINKY_TEST(strhRegister, AttemptUnalignedStore)
{
    emitInstruction16("0101001mmmnnnttt", R7, R3, R0);
...
PINKY_TEST(strhRegister, AttemptStoreToInvalidAddress)
{
    emitInstruction16("0101001mmmnnnttt", R7, R3, R0);
