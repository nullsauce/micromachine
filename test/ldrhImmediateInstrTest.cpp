...
PINKY_TEST(ldrhImmediate, UseAMixOfRegistersWordAligned)
{
...
PINKY_TEST(ldrhImmediate, UseAnotherMixOfRegistersNotWordAligned)
{
...
PINKY_TEST(ldrhImmediate, LargestOffset)
{
...
PINKY_TEST(ldrhImmediate, AttemptLoadFromInvalidAddress)
{
