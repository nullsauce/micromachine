...
{
	code_gen().emit16bit("0001110iiinnnddd", 7, R0, R0);
...
{
	code_gen().emit16bit("0001110iiinnnddd", 0, R7, R7);
	setExpectedXPSRflags("nzcv");
...
{
	code_gen().emit16bit("0001110iiinnnddd", 3, R7, R0);
	setExpectedXPSRflags("nzcv");
...
{
	code_gen().emit16bit("0001110iiinnnddd", 1, R6, R1);
	setExpectedXPSRflags("nZCv");
...
{
	code_gen().emit16bit("0001110iiinnnddd", 1, R2, R5);
	setExpectedXPSRflags("NzcV");
...
{
	code_gen().emit16bit("00110dddiiiiiiii", R0, 255);
	setExpectedXPSRflags("nzcv");
...
{
	code_gen().emit16bit("00110dddiiiiiiii", R7, 0);
	setExpectedXPSRflags("nzcv");
	setExpectedRegisterValue(R7, 0x77777777U + 0U);
	step();
}
...
{
	code_gen().emit16bit("00110dddiiiiiiii", R3, 1);
	setExpectedXPSRflags("nZCv");
