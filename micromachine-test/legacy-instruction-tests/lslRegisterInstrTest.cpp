...
{
	code_gen().emit16bit("0100000010mmmddd", R0, R7);
...
{
	code_gen().emit16bit("0100000010mmmddd", R4, R3);
	setExpectedXPSRflags("Nzc");
...
{
	code_gen().emit16bit("0100000010mmmddd", R7, R0);
	setExpectedXPSRflags("nZC");
...
{
	code_gen().emit16bit("0100000010mmmddd", R3, R4);
	setExpectedXPSRflags("NzC");
