...
{
	code_gen().emit16bit("1011001010mmmddd", R7, R0);
...
{
	code_gen().emit16bit("1011001010mmmddd", R0, R7);
...
{
	code_gen().emit16bit("1011001010mmmddd", R6, R1);
...
{
	code_gen().emit16bit("1011001010mmmddd", R2, R5);
