...
{
	code_gen().emit16bit("0100000101mmmddd", R1, R1);
...
{
	code_gen().emit16bit("0100000101mmmddd", R0, R0);
	setExpectedXPSRflags("nZcv");
...
{
	code_gen().emit16bit("0100000101mmmddd", R7, R7);
	setExpectedXPSRflags("NzcV");
...
{
	code_gen().emit16bit("0100000101mmmddd", R1, R2);
	setExpectedXPSRflags("nzcv");
