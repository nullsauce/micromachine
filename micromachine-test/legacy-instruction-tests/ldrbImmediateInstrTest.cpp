...
{
	code_gen().emit16bit("01111iiiiinnnttt", 0, R7, R0);
...
{
	code_gen().emit16bit("01111iiiiinnnttt", 1, R0, R7);
...
{
	code_gen().emit16bit("01111iiiiinnnttt", 2, R1, R4);
...
{
	code_gen().emit16bit("01111iiiiinnnttt", 3, R2, R5);
...
{
	code_gen().emit16bit("01111iiiiinnnttt", 31, R3, R0);
...
{
	code_gen().emit16bit("01111iiiiinnnttt", 0, R3, R0);
