...
{
	code_gen().emit16bit("0001101mmmnnnddd", R0, R0, R0);
...
{
	code_gen().emit16bit("0001101mmmnnnddd", R7, R7, R7);
	setExpectedXPSRflags("nZCv");
...
{
	code_gen().emit16bit("0001101mmmnnnddd", R1, R2, R0);
	setExpectedXPSRflags("nzCv");
...
{
	code_gen().emit16bit("0001101mmmnnnddd", R1, R0, R2);
	setExpectedXPSRflags("Nzcv");
