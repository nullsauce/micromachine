...
{
	code_gen().emit16bit("00001iiiiimmmddd", IMM_1, R2, R0);
...
{
	code_gen().emit16bit("00001iiiiimmmddd", IMM_32, R7, R0);
	setExpectedXPSRflags("nZc");
...
{
	code_gen().emit16bit("00001iiiiimmmddd", IMM_1, R1, R7);
	setExpectedXPSRflags("nzC");
...
{
	code_gen().emit16bit("00001iiiiimmmddd", IMM_32, R0, R0);
	setExpectedXPSRflags("nZC");
