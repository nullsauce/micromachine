...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_EQ, 0);
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_NE, 0);
	setExpectedXPSRflags("Z");
	setZero();
	step();
}
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_CS, 0);
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_CC, 0);
	setExpectedXPSRflags("C");
	setCarry();
	step();
}
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_MI, 0);
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_PL, 0);
	setExpectedXPSRflags("N");
	setNegative();
	step();
}
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_VS, 0);
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_VC, 0);
	setExpectedXPSRflags("V");
	setOverflow();
	step();
}
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_HI, 0);
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_LS, 0);
	setExpectedXPSRflags("Cz");
	setCarry();
	clearZero();
	step();
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_GE, 0);
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_LT, 0);
	setExpectedXPSRflags("NV");
	setNegative();
	setOverflow();
	step();
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_GT, 0);
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_LE, 0);
	setExpectedXPSRflags("zNV");
	clearZero();
	setNegative();
	setOverflow();
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_EQ, 127);
	setExpectedXPSRflags("Z");
	setZero();
...
{
	code_gen().emit16bit("1101cccciiiiiiii", COND_EQ, -128);
	setExpectedXPSRflags("Z");
	setZero();
...
{
	code_gen().emit16bit("11100iiiiiiiiiii", 0);
	setExpectedRegisterValue(registers::PC, INITIAL_PC + 4);
	step();
}
...
{
	code_gen().emit16bit("11100iiiiiiiiiii", 1023);
...
{
	code_gen().emit16bit("11100iiiiiiiiiii", -1024);
