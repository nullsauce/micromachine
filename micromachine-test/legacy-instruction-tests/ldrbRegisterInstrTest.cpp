...
{
	code_gen().emit16bit("0101110mmmnnnttt", R7, R3, R0);
...
{
	code_gen().emit16bit("0101110mmmnnnttt", R1, R0, R7);
...
{
	code_gen().emit16bit("0101110mmmnnnttt", R0, R7, R4);
...
{
	code_gen().emit16bit("0101110mmmnnnttt", R0, R7, R5);
	setRegisterValue(R7, INITIAL_PC);
