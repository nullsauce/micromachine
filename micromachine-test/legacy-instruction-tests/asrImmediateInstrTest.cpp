...
{
	code_gen().emit16bit("00010iiiiimmmddd", IMM_1, R0, R7);
...
{
	code_gen().emit16bit("00010iiiiimmmddd", IMM_1, R7, R0);
...
{
	code_gen().emit16bit("00010iiiiimmmddd", IMM_32, R0, R0);
	setRegisterValue(R0, 0x80000000U);
	setExpectedXPSRflags("NzC");
...
{
	code_gen().emit16bit("00010iiiiimmmddd", IMM_32, R1, R6);
...
{
	code_gen().emit16bit("00010iiiiimmmddd", IMM_1, R1, R7);
	setExpectedXPSRflags("nzC");
...
{
	code_gen().emit16bit("00010iiiiimmmddd", IMM_1, R7, R2);
	setExpectedXPSRflags("nzC");
...
{
	code_gen().emit16bit("00010iiiiimmmddd", IMM_1, R0, R0);
	setExpectedXPSRflags("nZc");
