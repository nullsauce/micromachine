...
{
	code_gen().emit16bit("1011010Mrrrrrrrr", 1, 0);
...
{
	code_gen().emit16bit("1011010Mrrrrrrrr", 0, 1);
	setExpectedRegisterValue(registers::SP, INITIAL_SP - 4);
...
{
	code_gen().emit16bit("1011010Mrrrrrrrr", 0, 1 << 7);
	setExpectedRegisterValue(registers::SP, INITIAL_SP - 4);
	memory_write_32(INITIAL_SP - 4, 0xFFFFFFFF);
	step();
...
{
	code_gen().emit16bit("1011010Mrrrrrrrr", 1, 0xFF);
