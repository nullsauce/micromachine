...
{
	code_gen().emit16bit("0001100mmmnnnddd", R0, R0, R0);
...
{
	code_gen().emit16bit("0001100mmmnnnddd", R7, R7, R7);
	setExpectedXPSRflags("NzcV");
...
{
	code_gen().emit16bit("0001100mmmnnnddd", R1, R2, R3);
	setExpectedXPSRflags("nzcv");
...
{
	code_gen().emit16bit("0001100mmmnnnddd", R1, R2, R0);
	setExpectedXPSRflags("nZCv");
...
{
	code_gen().emit16bit("01000100dmmmmddd", R1, R1);
...
{
	code_gen().emit16bit("01000100dmmmmddd", R0, R0);
	setExpectedRegisterValue(R0, 0U);
	step();
}
...
{
	code_gen().emit16bit("01000100dmmmmddd", R12, R12);
...
{
	code_gen().emit16bit("01000100dmmmmddd", R2, R1);
...
{
	code_gen().emit16bit("01000100dmmmmddd", R11, R10);
...
{
	code_gen().emit16bit("01000100dmmmmddd", registers::SP, R1);
...
{
	code_gen().emit16bit("01000100dmmmmddd", registers::LR, R1);
	setRegisterValue(R1, 1);
...
{
	code_gen().emit16bit("01000100dmmmmddd", registers::PC, R1);
	setRegisterValue(R1, 1);
