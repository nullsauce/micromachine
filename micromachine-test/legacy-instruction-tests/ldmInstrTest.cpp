...
{
	code_gen().emit16bit("11001nnnrrrrrrrr", R7, (1 << 0));
...
{
	code_gen().emit16bit("11001nnnrrrrrrrr", R0, (1 << 7));
...
{
	code_gen().emit16bit("11001nnnrrrrrrrr", R0, 0xFF);
	setRegisterValue(R0, INITIAL_PC + 16);
...
{
	code_gen().emit16bit("11001nnnrrrrrrrr", R7, 0x7F);
	setRegisterValue(R7, INITIAL_PC + 16);
	setExpectedRegisterValue(R0, 0);
	setExpectedRegisterValue(R1, 1);
	setExpectedRegisterValue(R2, 2);
...
{
	code_gen().emit16bit("11001nnnrrrrrrrr", 0, (1 << 0));
