...
{
	code_gen().emit16bit("0100000110mmmddd", R0, R0);
...
{
	code_gen().emit16bit("0100000110mmmddd", R7, R7);
	setExpectedXPSRflags("nZCv");
...
{
	code_gen().emit16bit("0100000110mmmddd", R1, R2);
	setExpectedXPSRflags("nzCv");
...
{
	code_gen().emit16bit("0100000110mmmddd", R1, R0);
	setExpectedXPSRflags("Nzcv");
