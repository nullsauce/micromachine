...
{
	code_gen().emit16bit("10001iiiiinnnttt", 0, R7, R0);
...
{
	code_gen().emit16bit("10001iiiiinnnttt", 1, R0, R7);
...
{
	code_gen().emit16bit("10001iiiiinnnttt", 31, R1, R6);
...
{
	code_gen().emit16bit("10001iiiiinnnttt", 0, R3, R0);
